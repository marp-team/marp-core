...
export const createMarpAutoScaling = (Base: typeof HTMLElement) =>
  class MarpAutoScaling extends Base {
  ...
  <svg part="svg" ${dataSvg}>
    ...
    private updateSVGRect() {
      ...
      if (this.container) {
        ...
        this.container.style.marginRight = svgPar.startsWith('xmi')
          ? 'auto'
          : '0'
      }
    }
...
export type MarpAutoScaling = InstanceType<
  ReturnType<typeof createMarpAutoScaling>
>
